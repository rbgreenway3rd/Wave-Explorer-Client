...
export const DOC_SECTIONS = [
  ...
  },
  {
    ...
    group: "pipeline",
    title: "6. F/Fo normalization",
    what: "An opt-in toggle (in the F/Fo Normalization panel, off by default). When on, it expresses each well's signal as a fold-change over its own resting brightness, so a bright well and a dim well can be compared fairly. Runs AFTER detrending. (A plate-wide rescale that puts the numbers in an easier range is planned.)",
  ...
  },
  {
    ...
    what: "Two reference lines on the graph. The baseline line sets how far above rest a bump must rise to be considered; the activity line marks a level used to gauge whether a well is active.",
    why: "They give you a visible, adjustable cutoff so borderline bumps are handled consistently.",
    analogy: "Like a height bar at a fairground ride — only what clears the bar counts.",
  },
  {
    id: "step-bursts",
    group: "pipeline",
  ...
  },
  {
    ...
    what: "An adjustable reference line used to judge whether a well is active.",
    why: "Gives a consistent, visible cutoff across wells instead of an eyeball judgment.",
  },
  {
    id: "param-baseline-threshold",
    group: "parameters",
    title: "Baseline threshold",
    what: "The line marking how far above the resting level a bump must rise before it's considered.",
    why: "Sets the floor for what counts, separate from the prominence rule.",
  },
  {
