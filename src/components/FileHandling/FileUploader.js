...
//         // Step 1: Reset the project context before processing the new file
//         resetProject();

//         // Step 2: Extract all data from the file
//         await extractAllData(fileContent);

//         // Step 3: Set state to trigger data distribution
